...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commont = __webpack_require__(49);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = new _vuex2.default.Store({
	  ...
	  mutations: {
	    ...
	    updateMsg: function updateMsg(state, msg) {
	      var tempComment = {
	        author: 'wang xiang',
	        content: msg
	      };
	  ...
	  getters: {
	    ...
	    totalMsg: function totalMsg(state) {
	      return state.msgList.length;
	    },
	    msgCountBy: function msgCountBy(state, name) {
	      return state.msgList.filter(function (msg) {
	        return msg.author === state.selectedName;
	      }).length;
	    }
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-ec1fc518/commont.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	exports.default = {
		...
		computed: {
			message: {
				get: function get() {
					return this.$store.getters.newComment.content;
				},
